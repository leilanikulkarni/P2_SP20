...
print(my_list[1])  # Bev
print(my_list[-1])  # Gus
print(my_list[:4])  # Bev to Dan as a list
...
print(max(my_numlist))  # returns the highest
...
# INDEX VARIABLE LOOOP (works directly with the list using indexes)
...
# LIST COMPREHENSIONS
# [returned item FOR iterator IN list/range IF filter]
...
# filter out so we only show double [1, 1] etc
